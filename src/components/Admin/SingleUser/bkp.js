...
const UserAssets = () => {
  ...
  const [transactionDetailMinus, settransactionDetailMinus] = useState({
    amount: "",
    txId: "",
    fromAddress: "",
    note: "",
  ...
  let handleTransactionMinus = (e) => {
    let name = e.target.name;

    let value = e.target.value;
    settransactionDetailMinus({ ...transactionDetailMinus, [name]: value });
  };
